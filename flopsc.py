...
from lowcost_resnet import ResNet, BasicBlock
...
if __name__ == '__main__':
    model = ResNet(BasicBlock, [2, 2, 2], activation=None)
    ...
    testset = CIFAR10(root='/home/palm/PycharmProjects/DATA/cifar10', train=False, download=True,
    ...
    for batch_idx, (inputs, targets) in enumerate(testloader):
        ...
        if batch_idx > 10:
            break
    print(model.compute_average_flops_cost())
